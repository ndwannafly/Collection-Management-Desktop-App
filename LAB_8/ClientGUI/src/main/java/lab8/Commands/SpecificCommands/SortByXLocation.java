...
public class SortByXLocation extends Command implements Serializable {

    private Receiver receiver;
    private static final long serialVersionUID = 1234567L;

    public SortByXLocation(){

    }

    public SortByXLocation(Receiver receiver){
        this.receiver = receiver;
    }
    @Override
    public String aboutCommand() {
        return "sort_by_x_location";
    }
