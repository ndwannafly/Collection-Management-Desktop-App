...
public class SortByYLocation extends Command implements Serializable {

    private Receiver receiver;
    private static final long serialVersionUID = 1234567L;

    public SortByYLocation(){

    }

    public SortByYLocation(Receiver receiver){
        this.receiver = receiver;
    }
    @Override
    public String aboutCommand() {
        return "sort_by_y_location";
    }
